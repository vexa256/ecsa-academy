    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-gray">
                <h5 class="modal-title">Create a new Modular-Test for the course :
            ...
            <div class="modal-body ">
                ...
                <form action="{{ route('MassInsert') }}" class="row" method="POST" enctype="multipart/form-data"> @csrf
                    ...
                    <input type="hidden" name="Type" value="ModularTest">



                    <input type="hidden" name="uuid" value="uuid{{ time() . substr(md5(uniqid()), 0, 14) }} ">

                    <input type="hidden" name="TID" value="TID{{ time() . substr(md5(uniqid()), 0, 14) }} ">
