<div class="row">
    <div class="col-12">
        ...
        {{ HeaderBtn($Toggle = '#', $Class = 'btn-danger PreTestAdded  float-end', $Label = 'Post-Test Already Added', $Icon = 'fa-plus') }}

        @else

        {{ HeaderBtn($Toggle = 'New', $Class = 'btn-danger  float-end', $Label = 'New Course Post-Test', $Icon = 'fa-plus') }}
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li>
                                <a href="{{ route('SetPostTestQuestions', ['TID'=> $data->TID]) }}" class="dropdown-item" href="#">Attach Questions</a>
                            </li>
