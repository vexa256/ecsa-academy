<div class="row">
    <div class="col-12">
        {{ HeaderBtn($Toggle = 'New', $Class = 'btn-danger float-end', $Label = 'New Test Question', $Icon = 'fa-plus') }}
    </div>
</div>
            ...
            @isset($DatabaseData)
                @foreach ($DatabaseData as $data)
                    <tr>
                        ...
                        <td class=" fw-bolder">{{ $data->CorrectAnswerOption }}</td>
                        <td>
                            <div class="dropdown">
