<div class="row">
    <div class="col-12">
        {{ HeaderBtn($Toggle = 'New', $Class = 'btn-danger float-end', $Label = 'New Module Session', $Icon = 'fa-plus') }}
    </div>
</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-danger btn-sm" data-gallery="manual" data-title="{{ $data->SessionName }}" href="{{ ensureAssetPath($data->ThumbNail) }}">
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li>
                                <a data-msg="You want to delete this record. This action is not reversible!!" data-route="{{ route('MassDelete', ['TableName' => 'sessions', 'id' => $data->id]) }}" class="dropdown-item deleteConfirm" href="#">Delete</a>
                            </li>
                        </ul>
                    </div>
                </td>
...
<form enctype="multipart/form-data" action="{{ route('MassUpdate') }}" class="" method="POST">
    ...
    <div class="row">
        ...
        {{ RunUpdateModalFinal($ModalID = $up->id, $Extra = '', $csrf = null, $Title = null, $RecordID = $up->id, $col = '12', $te = '12', $TableName = 'sessions') }}
    </div>
    {{ _UpdateModalFooter() }}
</form>
@endforeach
...
@isset($DatabaseData)
@include('main-ui.DescViewer', ['DisplayData' => $DatabaseData, 'DescColumn' => 'SessionDetails'])
@endisset
